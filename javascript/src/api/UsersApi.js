...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorModel', 'model/User'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorModel'), require('../model/User'));
  } else {
    // Browser globals (root is window)
    if (!root.Tutorial) {
      root.Tutorial = {};
    }
    root.Tutorial.UsersApi = factory(root.Tutorial.ApiClient, root.Tutorial.ErrorModel, root.Tutorial.User);
  }
}(this, function(ApiClient, ErrorModel, User) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/User} opts.username The user to create.
